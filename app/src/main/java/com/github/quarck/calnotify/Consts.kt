...
object Consts {
    ...
    const val MAX_CAL_RELOAD_TIME_DEFAULT = 7000L
    const val MAX_CAL_RELOAD_TIME_ON_UPDATE_MILLIS = 20000L
    const val MAX_CAL_RELOAD_TIME_ON_BOOT_MILLIS = 20000L
    const val MAX_CAL_RELOAD_TIME_ON_CALENDAR_CHANGED_MILLIS = 20000L
    const val MAX_CAL_RELOAD_TIME_ON_AFTER_FIRE_MILLIS = 7000L
    const val MAX_CAL_RELOAD_TIME_ON_UI_START_MILLIS = 10000L
